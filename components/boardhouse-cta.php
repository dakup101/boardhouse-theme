<div class="relative overflow-hidden pt-10 pb-52">
		...
		<div class="w-6/12 ">
			...
			<div class="w-full flex bg-white gap-1 relative">
                ...
                <div class="absolute -bottom-16 left-1/2 -translate-x-1/2 w-full flex items-center justify-center flex-col gap-3">
                    <a href="#" class="flex items-center justify-center gap-3 uppercase bg-dark font-bold text-white px-5 text-lg py-3 w-1/2 hover:bg-green transition-all">
                        Dodaj do koszyka
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-caret-right-fill" viewBox="0 0 16 16">
                            <path d="m12.14 8.753-5.482 4.796c-.646.566-1.658.106-1.658-.753V3.204a1 1 0 0 1 1.659-.753l5.48 4.796a1 1 0 0 1 0 1.506z"/>
                        </svg>
                    </a>
                    <a href="#" class="underline-offset-1 underline text-orange font-light hover:text-green transition-all">Zobacz wszystkie produkty</a>
                </div>
            </div>
		</div>
	</div>
