<div class="relative overflow-hidden pt-10 lg:pt-20 pb-20 lg:pb-64">
    <div class="container relative z-20 mx-auto flex">
        ...
        <div class="w-full lg:w-6/12 ">
            ...
            <div class=" lg:w-10/12 2xl:w-9/12 flex flex-col gap-2 mt-10 mb-10 lg:mt-0 lg:mb-20">
                <span class="text-center lg:text-left text-4xl font-bold">Curabitur vitae molestie! Nibh
                    phasellus.</span>
                <span class="text-center lg:text-left">Sed tempor massa id lorem sollicitudin, eleifend iaculis nunc
                    tempor</span>
            </div>
    ...
    <img src="<?php echo THEME_IMG . '/babeczki.jpg' ?>" alt=""
