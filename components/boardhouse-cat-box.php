...
<div class="cat-box relative aspect-square w-full overflow-hidden">
    <a href="<?php echo get_term_link($el['link']); ?>"
        class="absolute w-full h-full top-0 left-0 flex items-center justify-center gap-3 md:gap-5 lg:gap-10 flex-col z-20 hover:bg-green/60 focus:bg-dark/20 transition-all">
