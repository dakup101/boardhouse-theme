<div class="w-full sticky top-0 left-0 z-50">
    <div class="container mx-auto flex gap-10 py-8">
        <a href="<?php echo get_home_url();?>" class="block h-14 shrink-0">
        ...
        <div class="flex items-center justify-start gap-10 w-full" data-nav>
			...
			<?php foreach ( $menu as $value ) : ?>
                <a href="<?php echo $value['url']; ?>"
                   class="uppercase font-medium text-lg hover:text-orange focus:text-light-gray transition-all"
                >
