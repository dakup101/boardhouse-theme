<div class="w-full sticky top-0 left-0">
    <div class="container mx-auto flex gap-10 py-3">
        <img src="<?php echo THEME_IMG . '/logo.svg' ?>" alt="BOARDHOUSE" class="h-10">
        <!--  Site Nav  -->
        ...
        <!--  User Nav  -->
        <div class="flex gap-6 items-center pl-10 border-l-2 border-l-light-gray shrink-0">
            <a href="#"
