...
$is_from = null;
$is_for = null;
if ($attrs['pa_dla-kogo']) $is_for = $attrs['pa_dla-kogo'] ;
...
<div>
    ...
    <div class="grid grid-cols-2 gap-5 mt-5 mb-5">
        ...
        <div class="righty  flex flex-col gap-5">
            ...
            ?>
            <?php if (!is_not_hidden_attr($term_name) && $show_counter < 3 ) : ?>
            ...
            <?php $show_counter++; endif; ?>
            <?php endforeach; ?>
        </div>
    </div>
    <?php if ($show_counter > 2) : ?>
    <div class="grid grid-cols-2 gap-5 mb-5">
        <?php  $show_counter = 0; foreach ($attrs as $attr) : ?>
        <?php
                $term_name = $attr->get_name();
                $term_label = wc_attribute_label($term_name);
                $terms = null;
