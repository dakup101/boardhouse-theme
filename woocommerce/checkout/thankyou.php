...
<section class="w-full lg:w-7/12 mx-auto mt-10">
    <div class="woocommerce-order">
        ...
        <ul class="bg-light-gray/30 px-5 py-5 flex flex-col mb-5">
            ...
            <li class="py-3 flex flex-col gap-0.5 font-light border-t border-light-gray">
                ...
                <p><?php echo wc_format_datetime( $order->get_date_created() ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
                </p>
            </li>
            <li class="py-3 flex flex-col gap-0.5 font-light border-t border-light-gray">
                <p class="text-sm">
                ...
                <p><?php echo $order->get_formatted_order_total(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
                </p>
            </li>
            <li class="py-3 flex flex-col gap-0.5 font-light border-t border-light-gray">
                <p class="text-sm">
