...
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
	...
	<table class="w-full px-6 py-3 flex gap-6 flex-col bg-light-gray/50 font-light text-lg">
        ...
        <tr class="shipping-cos flex justify-between gap-3t">
            ...
            <td class="text-green font-medium tracking-wider"><?php echo WC()->cart->get_cart_shipping_total();; ?></td>
        </tr>
