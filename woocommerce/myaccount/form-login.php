...
<div class="u-columns col2-set" id="customer_login">
    ...
    <div class="u-column1 col-1 mt-10">
        ...
        <h2 class="text-2xl font-bold mb-5"><?php esc_html_e( 'Login', 'woocommerce' ); ?></h2>
        ...
        <form class="woocommerce-form woocommerce-form-login login" method="post">
            ...
            <p class="form-row">
                ...
                <button type="submit" class="btn-green w-full sm:w-fit px-10" name="login"
    ...
    <div class="u-column2 col-2 mt-10">
        ...
        <h2 class="text-2xl font-bold mb-5"><?php esc_html_e( 'Register', 'woocommerce' ); ?></h2>
        ...
        <form method="post" class="woocommerce-form woocommerce-form-register register"
            ...
            <p class="woocommerce-form-row form-row">
                ...
                <button type="submit" class="btn-green w-full sm:w-fit px-10" name="register"
